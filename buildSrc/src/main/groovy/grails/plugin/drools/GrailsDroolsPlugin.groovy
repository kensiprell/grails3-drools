...
class GrailsDroolsPlugin implements Plugin<Project> {
	...
	void apply(Project project) {
		...
		//project.task copyDroolsRule(dependsOn: project.tasks.processResources) << {
			println "TEST: copyDroolsRule"
		...
		project.task('writeDroolsContentXml') {
			println "TEST: writeDroolsContentXml"
